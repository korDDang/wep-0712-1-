...
int ma=0;
try{
	String sql="select max(productCode) from product0712";
...
if(storeCode==null){
	...
	try{
		String sql="select storeName from store0712 where storeCode=?";
		pstmt=conn.prepareStatement(sql);
...
<tr>
	<th class="th1">상품 코드(자동생성)</th>
		<td> <input type="text" name="productCode" value="<%=ma%>"> </td>
</tr>
<tr>
...
<tr>
	<th class="th1">매장코드</th>
		<td> <input type="text" name="storeCode" onchange="ch()" value="<%=storeCode%>"> </td>
</tr>
<tr>

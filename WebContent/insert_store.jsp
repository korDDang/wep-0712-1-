...
int se=0;
try{
	String sql="select sss123.nextval from dual";
...
if(productCode==null){
	...
	try{
		String sql="select productName from product0712 where productCode=?";
		pstmt=conn.prepareStatement(sql);
...
<tr>
	<th class="th1">매장 코드(자동생성)</th>
		<td> <input type="text" name="storeCode" value="<%=se%>"> </td>
</tr>
<tr>
...
<tr>
	<th class="th1">상품코드</th>
		<td> <input type="text" name="productCode" onchange="ch()" value="<%=productCode%>"> </td>
</tr>
<tr>
	<th class="th1">상품명</th>

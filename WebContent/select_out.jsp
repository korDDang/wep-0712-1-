...
double total1=0;
try{
	String sql="select to_char(i.inOutDate,'YYYY-MM-DD'),i.storeCode,s.storeName,i.productCode,p.productName,i.saleQty,p.unitPrice from product0712 p,store0712 s,inOut0712 i where i.storeCode=s.storeCode and i.productCode=p.productCode and i.gubun=1 ";
